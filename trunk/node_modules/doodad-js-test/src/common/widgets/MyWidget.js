	...
	global.DD_MODULES['MyWidget'] = {
		...
		create: function create(root, /*optional*/_options) {
			...
			return function init(/*options*/) {
				...
				namespaces.addEventListener('ready', function() {
					if (nodejs) {
						var myWidget = createMyWidget('myWidget1', 'Console !');
						var stream = new io.HtmlOutputStream();
						new io.TextPipeStream(stream, io.stdout);
					...
					//new io.TextPipeStream(io.stdin, io.stderr);
					//io.stdin.listen();
					
					//debugger;
					
					//myWidget.destroy();
					//tools.log(tools.LogLevels.Error, "hello");
					//types.invoke(myWidget, 'restorePreserved' , ['__styles']);
				});
			};
		},
	};
