...
(function() {
	...
	global.DD_MODULES['Doodad.Test.Types.Conversion'] = {
		type: 'TestUnit',
		version: '0d',
		namespaces: null,
		...
		proto: {
			run: function run(entry, /*optional*/options) {
				...
				command.run("[global.obj]", {eval: true},                     /**/ "global.obj");
				command.run("[]",    {eval: true},                            /**/ "[]");
				...
				command.run("[global.date]", {eval: true},                    /**/ "global.date");
				command.run("[global.err]", {eval: true},                     /**/ "global.err");
				command.run("[global.fn]", {eval: true},                      /**/ "global.fn");
				command.run("[Object.prototype.toString]", {eval: true},      /**/ "Object.prototype.toString");
				command.run("[Object]", {eval: true},                         /**/ "Object");
